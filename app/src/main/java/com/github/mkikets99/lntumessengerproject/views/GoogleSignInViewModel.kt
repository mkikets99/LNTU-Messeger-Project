...
import com.github.mkikets99.lntumessengerproject.models.User
        ...
        return callbackFlow {
            try {
                ...
                val googleIdOption: GetGoogleIdOption = GetGoogleIdOption.Builder()
                    ...
                    .setServerClientId(context.getString(R.string.default_web_client_id)) // This is required to identify the app on the backend server.
